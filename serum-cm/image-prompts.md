# 美容液CM「肌が応える、その瞬間。」篇 — 画像生成プロンプト集

使用ツール推奨：Midjourney / DALL-E 3
※ 全シーン共通でホワイト・ゴールド・ピンクベージュの上質なトーン
...
**シーン概要：** 女性が鏡の前で自分の肌に触れる。柔らかい朝の光

```
Photorealistic portrait of an elegant woman in her 30s touching her face gently,
looking into a mirror, soft morning window light,
serene and confident expression, luxury skincare commercial aesthetic,
clean minimal bathroom setting, white and gold tones,
shallow depth of field, ultra photorealistic, 8K, no text
```

---

## S4 — ボトルのクローズアップ（17〜23秒）

**シーン概要：** 美しいガラス容器に光が反射する製品ショット

```
Luxury cosmetic serum bottle product photography,
elegant glass bottle with golden cap, soft studio lighting reflecting on glass,
white and pink beige background, minimal premium aesthetic,
high-end beauty advertisement style, ultra photorealistic,
shallow depth of field, 8K, no text, no logo
```
...
```
Photorealistic portrait of a confident smiling woman in her 30s,
natural morning light, glowing healthy skin, elegant simple styling,
luxury lifestyle photography, soft warm tones, white and gold aesthetic,
shallow depth of field, ultra photorealistic, 8K, no text
```
...
| メイン背景 | ホワイト | #FAF7F2 |
| アクセント | ゴールド | #C9A769 |
| サブトーン | ピンクベージュ | #E8D5C4 |
| テキスト | ダークブラウン | #3A2E26 |

---

## Midjourneyパラメータ（全シーン共通）
